...
class SignUpForm(UserCreationForm):
    ...
    # modify default(add bootstrap) fields : username, password
...
class EditProfileForm(UserChangeForm):
    ...
    is_staff = forms.CharField(max_length=100, required=False , widget = forms.CheckboxInput(attrs={'class': 'form-check'}))
    is_active = forms.CharField(max_length=100,required=False , widget = forms.CheckboxInput(attrs={'class': 'form-check'}))
